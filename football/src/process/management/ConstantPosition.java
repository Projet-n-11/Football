...
public class ConstantPosition {
	...
	public static final int PENALTY2X=WIDTH - 12;
	public static final int PENALTY2Y=HEIGHT/2;
	
	public static final int ENGAGEMENTX=WIDTH/2;
	public static final int ENGAGEMENTY=HEIGHT/2;
	
	public static final int SIXYARD1X=INITIAL_POINT + 3;
	public static final int SIXYARD1Y=HEIGHT/2;
	public static final int SIXYARD2X=WIDTH - 3;
	public static final int SIXYARD2Y=HEIGHT/2;
